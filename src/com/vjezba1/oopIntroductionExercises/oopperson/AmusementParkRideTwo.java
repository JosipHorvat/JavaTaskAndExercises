...
/*
 Person matti = new Person("Matti");
        ...
        AmusementParkRideTwo hurjakuru = new AmusementParkRideTwo("Hurjakuru", 140);
...
public class AmusementParkRideTwo {
    ...
    public AmusementParkRideTwo(String name, int minimumHeight) {
        this.name = name;
